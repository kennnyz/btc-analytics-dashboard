...
export default function AsianRange() {
  ...
  const pieData = [
    { name: 'Up', value: ar.amd_up_pct },
    { name: 'Down', value: ar.amd_down_pct },
    { name: 'Inside', value: ar.amd_inside_pct },
  ];
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 16, marginBottom: 16 }}>
        <Card><SimplePie data={pieData} title="Day Direction" height={250} /></Card>
